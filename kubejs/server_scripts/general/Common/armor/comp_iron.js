...
ServerEvents.recipes(event =>{
	...
	['AAA', 'ABA', '   ' ],
	{ A: (PN('ingot_iron_compressed')), B: (MK('lapis_lazuli_helmet')) })
	event.shaped( Item.of(PNI('chestplate')),
	['A A', 'ABA', 'AAA' ],
	{ A: (PN('ingot_iron_compressed')), B: (MK('lapis_lazuli_chestplate')) })
    event.shaped( Item.of(PNI('leggings')),
	['AAA', 'ABA', 'A A' ],
	{ A: (PN('ingot_iron_compressed')), B: (MK('lapis_lazuli_leggings')) })
    event.shaped( Item.of(PNI('boots')),
	['   ', 'ABA', 'A A' ],
	{ A: (PN('ingot_iron_compressed')), B: (MK('lapis_lazuli_boots')) })
})